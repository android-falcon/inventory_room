...
//                String max=dbHandler.getMaxInDate("ITEM_CARD");
                String max=db.itemCard().getMaxInDate();
...
//                String max=dbHandler.getMaxInDate("ITEM_SWITCH");
                String max =db.itemSwitch().getMaxInDate();
                String maxInDate="";
                if(max.equals("-1")) {
...
//                String max=dbHandler.getMaxInDate("ITEM_UNITS");
                String max =db.itemUnit().getMaxInDate();
...
//                    }
                    db.unitName().deleteAll();
                    db.unitName().insertAll(ITEM);
...
//                    dbHandler.addItemcardTable(itemCard.get(i));
                ...
                MainActivity2  contextM=(MainActivity2)context;
                contextM.AddAssest(assestItems);
...
//                progressDialog.dismiss();
    ...
    public void addStk(List<Stk> stk){

        UserDaoStk userDao = db.stk();

        userDao.deleteAll();
        userDao.insertAll(stk);
    ...
    public void addQR(List<ItemQR> list){
